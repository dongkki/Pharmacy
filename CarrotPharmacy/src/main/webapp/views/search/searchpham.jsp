...
<%@ page import="java.util.*"%>
    ...
    <%-- <link rel="stylesheet" media="screen" href="<%=request.getContextPath() %>/views/vendor/bootstrap/dist/css/bootstrap.css" />  강사님 TEST하던 코드 일단 남겨둠...--%>
			...
			<div class="row mt-4 mb-n2">
				<div class="col-lg-6 col-md-8">
					<div class="input-group input-group-lg flex-nowrap shadow-sm">
						...
						<button class="btn btn-warning2 btn-lg fs-base home_search_btn btn-shadow text-white" type="submit">검색</button>
					</div>
				</div>
			</div>
	</div>
	...
	<div class="bg-light shadow-lg rounded-3 p-4 mt-n5 mb-4">
		<div class="d-flex justify-content-between align-items-center">
			<div class="dropdown me-2">
				<a class="btn btn-outline-secondary dropdown-toggle" href="#pharm-filters" data-bs-toggle="collapse">
								...
								<div class="accordion mt-n1" id="pharm-categories">
									...
									<div class="accordion-item">
										<h3 class="accordion-header">
											<a class="accordion-button collapsed" href="#location" role="button" data-bs-toggle="collapse" aria-expanded="false">지역구</a>
										</h3>
										<div class="accordion-collapse collapse" id="location" data-bs-parent="#pharm-categories">
                                        ...
                                        <ul class="widget-list widget-filter-list list-unstyled pt-1" style="max-height: 8rem;" data-simplebar data-simplebar-auto-hide="false">
                                            <li class="widget-filter-item d-flex justify-content-between align-items-center mb-1">
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label widget-filter-item-text" for="dayoftheweek">강남구</label>
                                                </div>
                                                <span class="fs-xs text-muted">436</span>
                                            </li>
                                            <li class="widget-filter-item d-flex justify-content-between align-items-center mb-1">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="dayoftheweek">
                                                    <label class="form-check-label widget-filter-item-text" for="dayoftheweek">강동구</label>
                                                </div><span class="fs-xs text-muted">236</span>
                                            </li>
                                            <li class="widget-filter-item d-flex justify-content-between align-items-center mb-1">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="dayoftheweek">
                                                    <label class="form-check-label widget-filter-item-text" for="dayoftheweek">강북구</label>
                                                </div><span class="fs-xs text-muted">167</span>
                                            </li>
                                            <li class="widget-filter-item d-flex justify-content-between align-items-center mb-1">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="dayoftheweek">
                                                    <label class="form-check-label widget-filter-item-text" for="dayoftheweek">강서구</label>
                                                </div><span class="fs-xs text-muted">256</span>
                                            </li>
                                            <li class="widget-filter-item d-flex justify-content-between align-items-center mb-1">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="dayoftheweek">
			...
			<aside class="col-lg-5 d-none d-lg-block">
				<div class="d-flex d-lg-block p-1 ms-auto w-100">
					<div class="position-relative bg-size-cover bg-position-center rounded-3 py-5 mb-grid-gutter" >
						<div  class="iframe-full-height-wrap" style =" width : 500px; height : 500px;" id ="googleMap" >
