		...
		<div class="d-flex justify-content-between align-items-center">
			<div class="dropdown me-2">
				<a class="btn btn-outline-secondary dropdown-toggle"
					href="#pharm-filters" data-bs-toggle="collapse"> <i
					class="ci-filter me-2"></i>Filters
				</a>
			</div>
...
<div class="container pb-5 mb-2 mb-md-4">
	<div class="row justify-content-center">
		...
		<!-- Products list-->
		<section class="col-lg-5 pt-2 offcanvas-body"
			style="overflow-y: scroll; height: 35rem; width: 500px;">
			<!-- Product-->
			<%if(pham ==null || pham.isEmpty()) {%>
			<div class="card product-card product-list">
				<span class="badge bg-info badge-shadow"></span>
			</div>

			<%}else{ %>
			<%for(SearchPham phams : pham){ %>
			<div class="card product-card product-list">
				<span class="badge bg-info badge-shadow"><small>영업중</small></span>
				...
				<div class="d-sm-flex align-items-center">
					...
					<div class="card-body py-2">
						...
						<h3 class="product-title fs-base">
							...
							<a href="<%=path%>"><%= phams.getPham_name() %></a>
						</h3>
						<h5 class="product-title fs-base">
							<div>
								<small><%= phams.getLocation_address() %></small>
							</div>
						</h5>
			...
			<div class="d-flex d-lg-block p-1 ms-auto w-100">
				<div
					...
					<div class="iframe-full-height-wrap"
						style="width: 500px; height: 500px;" id="googleMap">
					</div>
						<script
							src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAj4C5WATz3WZ5Rp8SRONI7VgimemfYK5k&callback=Map"></script>
				</div>
			</div>
		</aside>
		<div class="col-lg-1"></div>
