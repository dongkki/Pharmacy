...
<div class="container d-inline">
	<div class="row justify-content-center">
		<div class="col-lg-5 pb-3 alert-secondary px-lg-5 text-center" style="width: 45rem;">
			<form id="loginFrm"	action="<%=request.getContextPath()%>/phamlogin" method="post">
				...
				<div class="mt-5 mx-3">
	                <h1 class="h4 d-flex pb-2 fw-bold">약사 로그인</h1>
	                <h4 class="d-flex fs-lg mb-4">&nbsp;아이디 / 비밀번호를 활용한 로그인 방식입니다.</h4>
	            </div>
				<div class="password-toggle mx-3">
					<input class="form-control mb-2 fs-lg" type="text" name="id" id="id" required placeholder="아이디">
				...
				<div class="mb-3 d-flex justify-content-center">
                    <a href="<%=request.getContextPath() %>/views/user/enroll.jsp">회원가입</a>
                </div>
			</form>
		</div>
	</div>
