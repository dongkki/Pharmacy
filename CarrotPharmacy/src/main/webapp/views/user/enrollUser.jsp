                ...
                <div class="col-lg-5 alert alert-secondary px-lg-5 text-center" style="width: 45rem;">
	                <form class="signup_form" name="userEnrollFrm" action="<%= request.getContextPath() %>/enrollUser" method="POST">
                        ...
                        <div class="password-toggle">
						   <input class="form-control mb-3 fs-lg" type="text" name="id" id="signupId" required placeholder="아이디" style="width:500px; float: left;">
						   <input class="form-control mb-3 fs-lg" type="button" id="checkDuplicate" value="중복검사" style="width:100px; float: right;">
						   <input class="form-control mb-3 fs-lg" type="password" name="pw" id="signupPw" required placeholder="비밀번호">
						   <input class="form-control mb-3 fs-lg" type="password" name="pw2" id="signupPw2" required placeholder="비밀번호 확인">
						   <input class="form-control mb-3 fs-lg" type="text" name="name" id="signupName" required placeholder="이름">
						   <input class="form-control mb-3 fs-lg" type="text" name="phone" id="signupPhone" required placeholder="전화번호(-없이)">
						</div>
