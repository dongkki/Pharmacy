				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb breadcrumb-light flex-lg-nowrap justify-content-center justify-content-lg-start">
						...
						<li class="breadcrumb-item text-nowrap"><a href="<%=request.getContextPath() %>/views/profile/account-profile.jsp">마이페이지</a> </li>
                            ...
                            <li class="breadcrumb-item text-nowrap active" aria-current="page">즐겨찾는 의약품</li>
                        </ol>
                    </nav>
                </div>
                <div class="order-lg-1 pe-lg-4 text-center text-lg-start">
                    <h1 class="h3 text-light fw-bold mb-0">즐겨찾는 의약품</h1>
                </div>
            </div>
        </div>
</div>
            ...
            <div class="row">
                ...
                <section class="col-lg-8">
                    ...
                    <div class="d-none d-lg-flex justify-content-between align-items-center pt-lg-3 pb-4 pb-lg-5 mb-lg-3">
                        <h6 class="fs-base text-light mb-0">즐겨 찾는 의약품을 한눈에 확인해 보세요</h6><a class="btn btn-warning2 btn-sm" href="index.html"><i class="ci-sign-out me-2"></i>Sign out</a>
                    </div>
                    <!-- Wishlist-->
                    <!-- Item-->
                    	...
                    	<% } else { %>
		                    ...
		                    <div class="d-sm-flex justify-content-between mt-lg-4 mb-4 pb-3 pb-sm-2 border-bottom">
		                        <div class="d-block d-sm-flex align-items-start text-center text-sm-start">
		                            <a class="d-block flex-shrink-0 mx-auto me-sm-4" href="drug_detail.html" style="width: 10rem;"><img src="<%=request.getContextPath() %>/views/img/drug/<%=mark.getDrug_image()%>" alt="Product"></a>
		                            <div class="pt-2">
