                ...
                <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
                    <nav aria-label="breadcrumb">
						...
						<li class="breadcrumb-item text-nowrap"><a href="<%=request.getContextPath() %>/views/profile/account-profile.jsp">마이페이지</a> </li>
                            ...
                            <li class="breadcrumb-item text-nowrap active" aria-current="page">즐겨찾는 약국</li>
                        </ol>
                    </nav>
                </div>
                <div class="order-lg-1 pe-lg-4 text-center text-lg-start">
                    <h1 class="h3 text-light fw-bold mb-0">즐겨찾는 약국</h1>
                </div>
            </div>
        </div>
</div>
            ...
            <div class="row">
                ...
                <section class="col-lg-8">
                    ...
                    <div class="d-none d-lg-flex justify-content-between align-items-center pt-lg-3 pb-4 pb-lg-5 mb-lg-3">
                        <h6 class="fs-base text-light mb-0">즐겨 찾는 약국을 한눈에 확인해 보세요</h6><a class="btn btn-warning2 btn-sm" href="index.html"><i class="ci-sign-out me-2"></i>Sign out</a>
                    </div>
                    <!-- Wishlist-->
                    <!-- Item-->
