                    ...
                    <div class="bg-white rounded-3 shadow-lg pt-1 mb-5 mb-lg-0">
                        ...
                        <div class="d-lg-block collapse" id="account-menu">
                            ...
                            <ul class="list-unstyled mb-0">
                                ...
                                <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="<%=request.getContextPath() %>/views/profile/account-wishlist_pharm.jsp"><i class="ci-heart opacity-60 me-2"></i>즐겨찾기_약국</a></li>
